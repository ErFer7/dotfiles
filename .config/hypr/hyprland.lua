...
-- TODO: Check this - the original conf line "env = XMODIFIERS=@im,ibus" is malformed
-- hyprlang syntax (env = NAME,VALUE). Converted literally below, but you probably
-- meant: hl.env("XMODIFIERS", "@im=ibus")
